/*!
 ...
 !function(t, e) {
  ...
  var i = {
      ...
      render: function(t, e) {
          var r = e.props
            ...
            , i = e.data;
          i.routerView = !0;
          for (var a = o.$createElement, u = r.name, c = o.$route, s = o._routerViewCache || (o._routerViewCache = {}), p = 0, f = !1; o && o._routerRoot !== o; )
  ...
  var d, t = [String, Object], y = [String, Array], v = {
      name: "RouterLink",
      props: {
          to: {
              type: t,
      ...
      render: function(t) {
          var e, r, n = this, o = this.$router, i = this.$route, a = o.resolve(this.to, i, this.append), u = a.location, c = a.route, s = a.href, p = {}, f = o.options.linkActiveClass, h = o.options.linkExactActiveClass, l = null == f ? "router-link-active" : f, d = null == h ? "router-link-exact-active" : h, y = null == this.activeClass ? l : this.activeClass, v = null == this.exactActiveClass ? d : this.exactActiveClass, m = u.path ? E(null, u, null, o) : c;
          p[v] = O(i, m),
          p[y] = this.exact ? p[v] : (r = m,
          0 === (e = i).path.replace(R, "/").indexOf(r.path.replace(R, "/")) && (!r.hash || e.hash === r.hash) && function(t, e) {
              for (var r in e)
                  if (!(r in t))
                      return !1;
              return !0
  ...
  function q(p) {
      for (var f = new Array(p.length), t = 0; t < p.length; t++)
          "object" == typeof p[t] && (f[t] = new RegExp("^(?:" + p[t].pattern + ")$"));
      return function(t, e) {
              ...
              if ("string" != typeof a) {
                  ...
                  if (w(c)) {
                      ...
                      for (var s = 0; s < c.length; s++) {
                          if (u = o(c[s]),
                          !f[i].test(u))
                              throw new TypeError('Expected all "' + a.name + '" to match "' + a.pattern + '", but received `' + JSON.stringify(u) + "`");
                      ...
                      !f[i].test(u))
                          throw new TypeError('Expected "' + a.name + '" to match "' + a.pattern + '", but received "' + u + '"');
                      r += a.prefix + u
                  }
              } else
                  r += a
  ...
  function F(t, h) {
      ...
      function y(t, e, r) {
          ...
          if (o) {
              ...
              if ("object" != typeof n.params && (n.params = {}),
              e && "object" == typeof e.params)
                  for (var u in e.params)
                      !(u in n.params) && -1 < a.indexOf(u) && (n.params[u] = e.params[u]);
              if (i)
                  return n.path = H(i.path, n.params),
                  v(i, n, r)
          } else if (n.path) {
              n.params = {};
      ...
      function n(t, e) {
          ...
          !n || "object" != typeof n)
              return v(null, e);
          var o, i = n, a = i.name, u = i.path, c = e.query, s = e.hash, p = e.params;
          if (c = i.hasOwnProperty("query") ? i.query : c,
  ...
  var tt, et = m && ((-1 === (tt = window.navigator.userAgent).indexOf("Android 2.") && -1 === tt.indexOf("Android 4.0") || -1 === tt.indexOf("Mobile Safari") || -1 !== tt.indexOf("Chrome") || -1 !== tt.indexOf("Windows Phone")) && window.history && "pushState"in window.history), rt = m && window.performance && window.performance.now ? window.performance : Date, nt = ot();
  function ot() {
          ...
          pt(r, function(r, t, n, o) {
              if ("function" == typeof r && void 0 === r.cid) {
                  ...
                  var e, i = lt(function(t) {
                      var e;
                      ((e = t).__esModule || ht && "Module" === e[Symbol.toStringTag]) && (t = t.default),
                      r.resolved = "function" == typeof t ? t : d.extend(t),
                      n.components[o] = t,
                      --p <= 0 && c()
                  }), a = lt(function(t) {
                      var e = "Failed to resolve async component " + o + ": " + t;
                      f || (f = l(t) ? t : new Error(e),
                      c(f))
                  });
                  try {
                      e = r(i, a)
  ...
  dt.prototype.confirmTransition = function(r, e, t) {
      ...
      if (O(r, o) && r.matched.length === o.matched.length)
      ...
      var h = function(t, e) {
          ...
          try {
              t(r, o, function(t) {
                  !1 === t || l(t) ? (n.ensureURL(!0),
                  i(t)) : "string" == typeof t || "object" == typeof t && ("string" == typeof t.path || "string" == typeof t.name) ? (i(),
                  "object" == typeof t && t.replace ? n.replace(t) : n.push(t)) : e(t)
              })
          } catch (t) {
              i(t)
          }
  ...
  var mt = function(r) {
      ...
      ((t.prototype = Object.create(r && r.prototype)).constructor = t).prototype.go = function(t) {
          window.history.go(t)
      }
      ,
  ...
  var bt = function(n) {
      function t(t, e, r) {
          ...
          r && function(t) {
              var e = gt(t);
              if (!/^\/#/.test(e))
                  return window.location.replace(b(t + "/#" + e)),
                  !0
          }(this.base) || wt()
      }
      return n && (t.__proto__ = n),
      ((t.prototype = Object.create(n && n.prototype)).constructor = t).prototype.setupListeners = function() {
          var r = this
            , t = this.router.options.scrollBehavior
            , n = et && t;
          n && N(),
          window.addEventListener(et ? "popstate" : "hashchange", function() {
              var e = r.current;
  ...
  var Ot = function(r) {
      ...
      return r && (t.__proto__ = r),
      ((t.prototype = Object.create(r && r.prototype)).constructor = t).prototype.push = function(t, e, r) {
          var n = this;
          this.transitionTo(t, function(t) {
  ...
  Ct.prototype.resolve = function(t, e, r) {
      var n, o, i, a, u = D(t, e || this.history.current, r, this), c = this.match(u, e), s = c.redirectedFrom || c.fullPath, p = this.history.base;
      return {
          location: u,
          route: c,
          href: (n = p,
  ...
  ,
  Object.defineProperties(Ct.prototype, jt),
  Ct.install = function t(e) {
      if (!t.installed || d !== e) {
          t.installed = !0;
          var n = function(t) {
              return void 0 !== t
          ...
          (d = e).mixin({
              beforeCreate: function() {
                  n(this.$options.router) ? ((this._routerRoot = this)._router = this.$options.router,
  ...
  ,
  Ct.version = "3.0.2",
  m && window.Vue && window.Vue.use(Ct),
  Ct
});
